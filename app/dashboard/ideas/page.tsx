...
export default function IdeasPage() {
  return <Suspense fallback={<DashboardShell title="Ideas" eyebrow="BRAIN DUMP"><div className="brutal-card p-10 text-sm text-zinc-500">Loading ideas…</div></DashboardShell>}><IdeasContent /></Suspense>
}
